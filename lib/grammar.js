...
bnf = {
  ...
  Cascade: [
    o('Chain CASCADE', function(){
      return [$1];
    }), o('Cascade Chain CASCADE', function(){
      return $1.concat($2);
    })
  ],
  Expression: [
    ...
    }), o('Expression EVENT Expression', function(){
      return Event($1, $3, $2);
...
operators = [['left', 'POST_IF', 'FOR', 'WHILE'], ['right', 'BACKPIPE'], ['right', ',', 'ASSIGN', 'HURL', 'EXTENDS', 'INDENT', 'SWITCH', 'CASE', 'TO', 'BY', 'LABEL', 'WHERE'], ['left', 'PIPE'], ['left', 'EVENT'], ['right', 'LOGIC'], ['left', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['right', 'CONCAT'], ['left', 'SHIFT', 'IMPORT', 'CLONEPORT'], ['left', '+-'], ['left', 'MATH'], ['right', 'UNARY'], ['right', 'POWER'], ['right', 'COMPOSE'], ['nonassoc', 'CREMENT'], ['left', 'BACKTICK']];
tokens = (function(){
