...
exports.Event = Event = (function(superclass){
  ...
  prototype.findBase = function(target){
  ...
  prototype.compileNode = function(o){
    var t, ops, op, base, assign;
    t = this.target.compile(o);
    ops = {
      '<:': 'trigger',
      ':>': 'observe',
      '-:>': 'off',
    ...
    op = ops[this.method];
    base = this.findBase(t);
    assign = "this" === t
      ? t
      : t + " = " + t + " || {}";
    return util(op, o) + ".call(" + assign + ", " + this.observer.compile(o, LEVEL_LIST) + ", " + base + ")";
  };
  return Event;
}(Node));
...
UTILS = {
  ...
  advise: function(){
    util('prepareHandler');
    return function(advisor){
      prepareHandler$(this);
      this.__event_advisor.push(advisor);
    };
  },
  unadvise: function(){
    util('prepareHandler');
    ...
    return function(e){
      var t, ref$;
      prepareHandler$(this);
      if ((t = this.__event_advisor.indexOf(e)) > -1) {
        (splice$.apply(this.__event_advisor, [t, t + 1 - t].concat(ref$ = [])), ref$);
      }
    };
  },
  trigger: function(){
...
function util(fn, options){
  var func;
  if (!(options != null && options.util)) {
    func = UTILS[fn];
    if ({}.toString.call(func) === '[object Function]') {
      func = func();
    }
    return Scope.root.assign(fn + '$', func.toString());
  } else {
    return fn + '$';
  }
}
